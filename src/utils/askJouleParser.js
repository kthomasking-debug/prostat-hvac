...
const OFFLINE_KNOWLEDGE = {
  ...
  "differential": "A differential (dead band) is the temperature range where your HVAC doesn't run. Standard is 0.5°F. Joule recommends 1.0°F for efficiency - it reduces short cycling and saves energy while maintaining comfort.",
  "weather models": "The Big 4 weather models are: EC (European Centre/ECMWF) - most accurate globally, CMC (Canadian Meteorological Centre) - excellent for North America, GEFS (Global Ensemble Forecast System) - NOAA's ensemble with 30+ members, and AI ensembles (machine learning models like GraphCast, FourCastNet). Joule uses NWS (National Weather Service) forecasts which blend these models for US locations. Ensemble forecasts average multiple model runs to reduce uncertainty.",
  "weather model": "The Big 4 weather models are: EC (European Centre/ECMWF) - most accurate globally, CMC (Canadian Meteorological Centre) - excellent for North America, GEFS (Global Ensemble Forecast System) - NOAA's ensemble with 30+ members, and AI ensembles (machine learning models like GraphCast, FourCastNet). Joule uses NWS (National Weather Service) forecasts which blend these models for US locations. Ensemble forecasts average multiple model runs to reduce uncertainty.",
  "EC model": "EC (European Centre for Medium-Range Weather Forecasts, ECMWF) is considered the most accurate global weather model. It uses advanced data assimilation and has the highest resolution. Often used as the gold standard for forecast accuracy.",
